...
//
// Env:
//   PAYMENTS_URL: wss url (required, e.g. wss://agentchat-server.fly.dev)
...
const SERVER = process.env.PAYMENTS_URL;
if (!SERVER) { console.error('FATAL: PAYMENTS_URL is not set.'); process.exit(1); }
