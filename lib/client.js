...
export class AgentChatClient extends EventEmitter {
  ...
  async propose(to, proposal) {
    ...
    if (proposal.amount != null) msg.amount = proposal.amount;
    if (proposal.currency != null) msg.currency = proposal.currency;
    if (proposal.payment_code != null) msg.payment_code = proposal.payment_code;
    if (proposal.terms != null) msg.terms = proposal.terms;
    if (proposal.expires != null) msg.expires = proposal.expires;
    if (proposal.elo_stake != null) msg.elo_stake = proposal.elo_stake;
