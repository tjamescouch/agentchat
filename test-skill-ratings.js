...
const reputation_1 = require("./lib/reputation");
const path_1 = require("path");
const testDir = path_1.default.join(process.cwd(), '.test-reputation');
async function test() {
    console.log('🧪 Testing skill-scoped reputation system...\n');
    const store = new reputation_1.ReputationStore(path_1.default.join(testDir, 'test-ratings.json'));
    await store.load();
    // Get initial ratings
